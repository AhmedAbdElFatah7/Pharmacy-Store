      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            <a href="/house">Home</a> <span class="mx-2 mb-0">/</span>
            ...
            <div class="p-3 p-lg-5 border">
              <div class="form-group">
                ...
                <select id="c_country" class="form-control">
                  ...
                  <option value="7">Mansoura</option>
              ...
              <div class="form-group">
                <label for="c_ship_different_address" class="text-black" data-toggle="collapse"
                  ...
                  aria-controls="ship_different_address"></label>
                ...
                <div class="p-3 p-lg-5 border">
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Delivery price <strong class="mx-2"></strong> </td>
                        <td>30.00 $</td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
                        <td class="text-black font-weight-bold"><strong>{{$medicine->price + 30}}.00 $</strong></td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <div class="form-group">
                  <a href="{{route('thanks')}}"><button class="btn btn-primary btn-lg btn-block" >Place
                      Order</button></a>
                  </div>
                </div>
              </div>
